        ...
        <main className="flex-grow p-6">
          <div className="bg-white p-8 rounded-lg shadow-md w-4/5 mx-auto mt-6">
            ...
            <div className="bg-green-100 p-4 rounded-lg shadow-md mx-auto mb-8">
              ...
              Temporarily suspend all transfers of a specific token on the Hedera network. 
              Ensure that you have the necessary administrative permissions to pause token transfers, 
              as this action affects all token holders.
              </p>
            </div>
